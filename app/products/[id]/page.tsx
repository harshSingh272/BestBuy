...
import { getProductById, getSimilrProducts } from '@/lib/actions'
...
const ProductDetails = async ({ params: { id } }: Props) => {
  ...
  const similarProducts = await getSimilrProducts(id);
        ...
        <div className='flex-1 flex flex-col'>
          <div className='flex justify-between items-start gap-5
            ...
            <div className='flex items-center gap-3'>
              ...
              <div className='p-2 bg-white-200 rounder-10'>
                <Image
          ...
          <div className='product-info'>
            <div className='flex flex-col gap-2'>
              ...
              <p className='text-[16px] text-black opacity-50 line-through'>
